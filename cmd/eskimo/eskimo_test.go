...
const (
	...
	testDIDToken = "WyIweGFhNTBiZTcwNzI5Y2E3MDViYTdjOGQwMDE4NWM2ZjJkYTQ3OWQwZm" +
	...
	testUserID = "did:ethr:0x4B73C58370AEfcEf86A6021afCDe5673511376B2"
)
...
func TestMain(m *testing.M) {
	serverConnector = serverfixture.NewTestConnector(applicationYamlKey, swaggerRoot, expectedSwaggerJSON, order, main, usersfixture.RContainerMounts()...)
	testConnectors := usersfixture.RTestConnectors()
